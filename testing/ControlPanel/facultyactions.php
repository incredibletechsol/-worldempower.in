	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "save")
				...
				if(move_uploaded_file($_FILES['photo']['tmp_name'],$target_path))
					{
					$faculty_insert = "INSERT INTO tbl_faculty(name,designation,location,photo) values('$name','$designation','$location','$fileName')";
							
					mysqli_query($con,$faculty_insert) or die(mysqli_error());
		...
		<div id="boxes">
				<div style="top:150px; left: 551.5px; display: none;" id="dialog" class="window">
					...
					<div align="center" style="margin:5px 0 5px 0;">
						...
						<?php 
						echo "<p align='center'><h4><img src='images/Correct.png'>&nbsp;&nbsp;Team Saved Successfully.</h4></p>"; 
						?>
	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "delete")
				{
				$id = $_GET['id'];
				$fetch_existing_photo_query="SELECT photo FROM tbl_faculty where id='$id'";
		...
		<div id="boxes">
				<div style="top:150px; left: 551.5px; display: none;" id="dialog" class="window">
					...
					<div align="center" style="margin:5px 0 5px 0;">
						...
						<?php 
						echo "<p align='center'><h4><img src='images/Correct.png'>&nbsp;&nbsp;Team Deleted Successfully.</h4></p>"; 
						?>
	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "update")
				...
				if($fileSize <= 0) {
					$faculty_update = "UPDATE tbl_faculty SET name='$name',designation='$designation',location='$location' where id='$id'";
		
					mysqli_query($con,$faculty_update) or die(mysqli_error()); 
				}
				else {
						$fetch_existing_photo_query="SELECT photo FROM tbl_faculty where id='$id'";
						...
						if(move_uploaded_file($_FILES['photo1']['tmp_name'],$target_path))
							{
							$faculty_update = "UPDATE tbl_faculty SET name='$name',designation='$designation',location='$location',photo='$fileName' where id='$id'";
		...
		<div id="boxes">
				<div style="top:150px; left: 551.5px; display: none;" id="dialog" class="window">
					...
					<div align="center" style="margin:5px 0 5px 0;">
						...
						<?php 
						echo "<p align='center'><h4><img src='images/Correct.png'>&nbsp;&nbsp;Team Updated Successfully.</h4></p>"; 
						?>
